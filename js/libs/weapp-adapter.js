...
/***/ (function(module, exports, __webpack_require__) {
  ...
  wx.onTouchStart(touchEventHandlerFactory('touchcancelgamecanstart'))
  wx.onTouchStart(touchEventHandlerFactory('touchchangetodoublemodel'))
  wx.onTouchStart(touchEventHandlerFactory('touchreturnhome'))
  wx.onTouchStart(touchEventHandlerFactory('touchgetrank'))
  wx.onTouchStart(touchEventHandlerFactory('touchcloserank'))
